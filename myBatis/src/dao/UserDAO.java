...
import com.sej.mybatis.config.MyBatisConfig;
...
public class UserDAO {
	...
	public String findId(String userPhone) {
		return sqlSession.selectOne("User.findId", userPhone);
	}
	
	public void updateUserPassword(String userId, String userPassword) {
		sqlSession.update("User.updateUserPassword", userId, userPassword);
	}
	
	public void update(UserVO userVO) {
		sqlSession.update("User.updateUserPassword", userVO);
	}
	
	public UserVO selectUser(int userNumber) {
		return sqlSession.selectOne("User.selectUser", userNumber);
	}
